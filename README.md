Here you can add issues and see what we are planning to do in the near future
...
<strong>Publish your post forms using Gutenberg</strong>
...
<strong>WP Front User Submit PRO – Premium Features</strong>
...
* [Editor.js] Warning
* [Editor.js] Table
* [Editor.js] Carousel (gallery block) [more info](https://wpfronteditor.com/docs)
* [Editor.js] Attaches [more info](https://wpfronteditor.com/docs)
...
* Try an [Online Demo](http://demo.wpfronteditor.com/wp-login.php) of the FREE & PRO version.
...
= 3.4.0 =
* Added Admin Notification Configurations [more info](https://wpfronteditor.com/docs)
* Fixed issue on form creation
* Redirect on inserting or updating post configurations [more info](https://wpfronteditor.com/docs)
...
= 3.0.2 =
* Please recreate form after update
* added MD Editor 
...
= 2.0.1 =
* Plugin title changed
* Images in editor duplicating: bug fixed
* Pictures are not attached to the article: bug fixed
