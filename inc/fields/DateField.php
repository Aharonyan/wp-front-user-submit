...
class DateField
{
    ...
    public static function add_field_settings($data)
    {
        ...
        $data['formBuilder_options']['typeUserAttrs'][self::$field_type] = [
            ...
            'min' => ['label' => sprintf('%s', __('Min', 'front-editor')), 'value' => ''],
            'max' => ['label' => sprintf('%s', __('Max', 'front-editor')), 'value' => ''],
            'step' => ['label' => sprintf('%s', __('Step', 'front-editor')), 'value' => ''],
            'required_error_text' => ['label' =>  __('Required error text', 'front-editor'), 'placeholder' => 'Please add date field', 'value' => ''],
            'not_correct_post_title_text' => ['label' => __('Not correct content', 'front-editor'), 'placeholder' => 'Please add correct date', 'value' => ''],
        ];
