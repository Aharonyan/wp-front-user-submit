...
class TinyMCE {
    ...
    public static function init() {
        ...
        add_action(
            ...
            [__CLASS__, 'add_field_to_front_form'],
            10,
            3
        );
        add_action(
            'bfe_ajax_after_front_editor_post_update_or_creation',
            [__CLASS__, 'save_field_to_front_form'],
            10,
            4
        );
    ...
    public static function add_field_settings( $data ) {
        ...
        $data['formBuilder_options']['typeUserAttrs'][self::$field_type] = [
            ...
            'required_error_text'         => [
                ...
                'placeholder' => 'Please add editor field',
                'value'       => '',
            ],
            'not_correct_post_title_text' => [
                'label'       => __( 'Not correct content', 'front-editor' ),
                'placeholder' => 'Please add correct editor',
                'value'       => '',
            ],
        ];
        /**
     ...
     * @return void
     */
    public static function save_field_to_front_form(
        $post_id,
        $form_id,
        $post_data,
        $settings
