...
{
    public static $field_label = 'Paragraph] Field';
    public static $field_type =  'paragraph';
    ...
    public static function add_field_settings($data)
    {
        ...
        $field_label = __('Paragraph Field', 'front-editor');
    ...
    public static function add_field_to_front_form($post_id, $attributes, $field)
    {
        ...
        require fe_template_path('front-editor/paragraph.php');
    }
    ...
    public static function save_field_to_front_form($post_id)
    {
        ...
        foreach ($_POST['paragraph'] as $name => $value) {
