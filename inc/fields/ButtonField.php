...
class ButtonField
{
    public static $field_label = 'Button Field';
    public static $field_type =  'button';
    ...
    public static function add_field_settings($data)
    {
        ...
        $field_label = __('Button Field', 'front-editor');
    ...
    public static function add_field_to_front_form($post_id, $attributes, $field)
    {
        ...
        require fe_template_path('front-editor/button.php');
    }
    ...
    public static function save_field_to_front_form($post_id)
    {
        ...
        foreach ($_POST['button'] as $name => $value) {
